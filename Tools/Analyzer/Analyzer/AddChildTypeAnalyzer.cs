...
// 是在这个 [ChildTypeAttribute] 标签扫描时抛出来的错误 
    ...
    public class AddChildTypeAnalyzer: DiagnosticAnalyzer {
        ...
        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticIds.AddChildTypeAnalyzerRuleId,
                                     Title,
                                     MessageFormat,
